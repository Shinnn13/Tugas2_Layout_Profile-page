            ...
            children: [
              Container(
                  ...
                  child: const CircleAvatar(
                    backgroundImage:
                        AssetImage('assets/img/Me_With_EffectCartoon.jpg'),
                    radius: 60,
                  )),
              Column(
                children: [
                  Text('M. Sultan Ilham Seftiansyah',
                      style: GoogleFonts.poppins(
                          fontSize: 20,
                          color: const Color.fromARGB(255, 43, 42, 42),
                          fontWeight: FontWeight.bold)),
                  Text("sultan.065119013@unpak.ac.id",
                      style: GoogleFonts.poppins(
                        fontSize: 12,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                        child: Text(
                      "Jl Cikopo Selatan Kp. Nagrog RT 001/002, Desa Sukamahi, Kecamatan Megamendung 16670, Kabupaten Bogor, Jawa Barat, Indonesia, 43185",
                      style: GoogleFonts.poppins(
                        color: const Color.fromARGB(255, 197, 190, 190),
                        fontSize: 12,
                      ),
